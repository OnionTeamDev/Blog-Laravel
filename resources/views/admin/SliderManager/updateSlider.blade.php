                                        ...
                                        <div class="col-md-12">
                                            <form method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input required type="text" name="slider_name"
                                                            class="form-control" placeholder="Tên bài viết" value="{{$slider->slider_name}}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumbnail" value="{{$slider->slider_img}}" class="form-control" type="text" name="url_img" required>
                                                    </div>
                                                    <img src="{{$slider->slider_img}}" width="300px" alt="" srcset="">
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea required rows="5" name="slider_desc" cols="5"
                                                            class="form-control"
                                                            placeholder="Default textarea">{{$slider->slider_desc}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
