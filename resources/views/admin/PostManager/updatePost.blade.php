                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <h4 class="sub-title">Sửa bài viết</h4>
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input required type="text" name="post_name"
                                                            class="form-control" placeholder="Tên bài viết" value="{{$post->post_name}}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumbnail" value="{{$post->url_img}}" class="form-control" type="text" name="url_img" required>
                                                    </div>
                                                    <img src="{{$post->url_img}}" width="300px" alt="" srcset="">
                                                </div>
                                                <div class="form-group row">
                                                        ...
                                                        <select name="category_id" class="form-control">
                                                            @foreach ($category as $categorys)
                                                             ...
                                                             @foreach ($post->category as $item)
                                                                @if ($item->category_name == $categorys->category_name)
                                                                    selected
                                                                @endif
                                                             @endforeach
                                                             value="{{$categorys->id}}">{{$categorys->category_name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea required id="editor" rows="5" name="post_desc" cols="5"
                                                            class="form-control"
                                                            placeholder="Default textarea">{{$post->post_desc}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
